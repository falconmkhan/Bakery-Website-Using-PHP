      ...
      ?>
        <div class="col-sm-6 col-md-4">
          <div class="box shadow" data-aos="fade-up">
            <div class="img-box">
              <img src="./crud/images/<?php echo $bisc_cookies['image'] ?>" alt="">
            </div>
            <div class="detail-box1">
              <h5>
                <span><?php echo $bisc_cookies['name'] ?></span>
              </h5>
              <h6><?php echo $bisc_cookies['descr'] ?></h6>
              <h5><?php echo $bisc_cookies['price'] ?></h5>

              <a href="javascript:void(0);" class="buy-now-btn"
                data-name="<?php echo $bisc_cookies['name']; ?>"
                data-descr="<?php echo $bisc_cookies['descr']; ?>"
                data-price="<?php echo $bisc_cookies['price']; ?>"
                data-image="./crud/images/<?php echo $bisc_cookies['image']; ?>">
                Buy Now
              </a>
            </div>
          </div>
