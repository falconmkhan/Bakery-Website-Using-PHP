    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-2 mb-4">
                <a href="./all_menu.php" class="btn btn-sm btn-dark">ALL MENU</a>
            </div>
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        VALUE ('$name' , '$desc' , '$price' , '$imgname')");
            ...
            if ($insert) {
                ...
                $insert_menu = $conn->prepare("INSERT INTO menu (items_name , images , descr , price)
            VALUE('$name' , '$imgname' , '$desc' , '$price' )");
                $insert_menu->execute();
            } else {
