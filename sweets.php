      ...
      ?>
        <div class="col-sm-6 col-md-4">
          <div class="box shadow" data-aos="fade-up">
            <div class="img-box">
              <img src="./crud/images/<?php echo $sweets['image'] ?>" alt="">
            </div>
            <div class="detail-box1">
              <h5>
                <span><?php echo $sweets['name'] ?></span>
              </h5>
              <h6><?php echo $sweets['descr'] ?></h6>
              <h5><?php echo $sweets['price'] ?></h5>

              <a href="javascript:void(0);" class="buy-now-btn"
                data-name="<?php echo $sweets['name']; ?>"
                data-descr="<?php echo $sweets['descr']; ?>"
                data-price="<?php echo $sweets['price']; ?>"
                data-image="./crud/images/<?php echo $sweets['image']; ?>">
                Buy Now
              </a>
            </div>
          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="shadow-sm close" data-bs-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body">
          ...
          <form id="buyForm" action="https://api.web3forms.com/submit" method="POST">
            ...
            <input type="hidden" name="subject" value="New Sweet Order">
            <input type="hidden" name="Sweet_name" id="inputCakeName">
            <input type="hidden" name="Sweet_descr" id="inputCakeDescr">
            <input type="hidden" name="Sweet_price" id="inputCakePrice">
